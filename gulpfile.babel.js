// Generated on 2016-09-27 using generator-angular-fullstack 3.7.6
'use strict';
...
const paths = {
    ...
    server: {
        ...
        test: {
          integration: ['server/api/community/community.integration.js',
                         'server/api/user/user.integration.js',
                         'server/api/approval/approval.integration.js',
                         'server/api/employee/employee.integration.js',
                         'server/api/amenity/amenity.integration.js',
                         'server/api/complaint/complaint.integration.js',
                         'server/api/thread/thread.integration.js',
                         'server/api/comment/comment.integration.js',
                         'server/api/billservice/billservice.integration.js',
                         'server/api/userbillservice/userbillservice.integration.js',
                         'server/api/history/history.integration.js',
                         'server/api/expense/expense.integration.js',
                         'server/api/communitymembersmapping/communitymembersmapping.integration.js',
                         'server/api/visitor/visitor.integration.js',
                         'mocha.global.js'],
...
gulp.task('copy:fonts', () => {
    gulp.src(`${clientPath}/assets/fonts/**/*`, { dot: true })
